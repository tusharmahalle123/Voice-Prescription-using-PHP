...
$sql=mysqli_query($con,"Update receptionist set name='$docname',address='$docaddress',contactno='$doccontactno' where id='".$_SESSION['id']."'");
if($sql)
{
						...
						<div class="container-fluid container-fullw bg-white">
							<div class="row">
								<div class="col-md-12">
									...
									<?php $sql=mysqli_query($con,"select * from receptionist where email='".$_SESSION['dlogin']."'");
