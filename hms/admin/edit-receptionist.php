...
$email=$_POST['email'];
$sql=mysqli_query($con,"Update receptionist set name='$name',address='$address',contactno='$contactno',email='$email' where id='$did'");
if($sql)
{
...
<?php if($msg) { echo htmlentities($msg);}?> </h5>
									...
									<?php $sql=mysqli_query($con,"select * from receptionist where id='$did'");
