...
$sql=mysqli_query($con,"insert into receptionist(name,address,contactno,email,password) values('$name','$address','$contactno','$email','$password')");
if($sql)
{
...
<div class="form-group">
					...
					<input type="text" name="contact" class="form-control"  placeholder="Enter Receptionist Contact no" required="true">
														</div>
...
<input type="email" id="email" name="email" class="form-control"  placeholder="Enter Doctor Email id" required="true" onBlur="checkemailAvailability()">
